...
+ #bi-i("have a tendency to do", "有...的倾向；倾向于做...")
...
+ #bi-i("on a tour of", "在……巡回/参观")
+ #bi-i("be traced back to", "追溯到")
+ #bi-i("keep track of", "记录；追踪")
+ #bi-i("trade A for B", "用A换B")
+ #bi-i("be transferred to", "被转移到；被调到")
...
+ #bi-i("turn over a new leaf", "改过自新；翻开新的一页")
...
+ #bi-i("I won't attack others unless others attacks me.", "人若犯我，我必犯人。")
