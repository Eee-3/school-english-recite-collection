...
+ #bi-i("focused on their respective teams' strengths", "专注于各自团队的优势")
...
+ #bi-i("cluttered research process", "混乱的研究过程")
...
+ #bi-i("tank", "坦克；水槽")
+ #bi-i("swing from initial optimism to anxiety", "从最初的乐观转向焦虑")
...
+ #bi-i("long-term vision recognized ...", "被认可的长期愿景...")
